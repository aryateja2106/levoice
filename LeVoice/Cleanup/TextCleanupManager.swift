...
final class TextCleanupManager: ObservableObject, TextCleaningManaging {
    ...
    private static let systemPromptSentinel = "<|levoice-system-prefill-split|>"
    private static let userInputSentinel = "<|levoice-user-prefill-split|>"
    ...
    private var modelsDirectory: URL {
        ...
        return appSupport.appendingPathComponent("LeVoice/models", isDirectory: true)
    }
