...
private struct ConsentDialogView: View {
    ...
    private static let consentMessage = "I'm using 🌶️ LeVoice, a completely private AI note taker. Nothing leaves my computer and all AI models are done on device."
