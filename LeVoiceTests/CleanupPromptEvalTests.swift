...
///
/// Run with: `xcodebuild test -scheme LeVoice -testPlan CleanupPromptEvals`
/// Or individually: `xcodebuild test -scheme LeVoice -only-testing:LeVoiceTests/CleanupPromptEvalTests`
